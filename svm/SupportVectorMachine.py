...
# make_blobs函数是为聚类产生数据集  n_samples:表示数据样本点个数,默认值100  centers:默认3个，也就是0，1，2,指的是y的取值范围  random_state:随机种子，相同的值具有可重现性。相同的值可重现性
print (X)
print (y)
...
# print("_________________________",YY)
# print(XX)
